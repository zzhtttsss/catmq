...
import org.catmq.storage.segment.KeyValueStorageFactory.*;
...
public class KeyValueStorageRocksDB implements KeyValueStorage {
    ...
    public KeyValueStorageRocksDB(String basePath, String subPath, DbConfigType dbConfigType)
            throws IOException {
        this(basePath, subPath, dbConfigType, false);
    }
    ...
    private RocksDB initializeRocksDBWithConfFile(String basePath, String subPath, DbConfigType dbConfigType,
                                                  boolean readOnly, String dbFilePath) throws IOException {
